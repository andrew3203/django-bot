...
WSGI_APPLICATION = 'corporatum.wsgi.application'
ASGI_APPLICATION = 'corporatum.asgi.application'
...
PROVIDER_TOKEN = os.getenv("PROVIDER_TOKEN", default=None)
